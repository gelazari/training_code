...
def getData_OCT(data_directory, train_batchsize, dataset, shuffle_mode, augmentation_train, augmentation_test):
    ...
    test_dataset = CustomDataset_OCT(test_image_folder, test_label_folder, teacher_student=False, transforms=augmentation_test)
...
class CustomDataset_OCT(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        all_images = glob.glob(os.path.join(self.imgs_folder, '*.tiff'))
        all_labels = glob.glob(os.path.join(self.labels_folder, '*.tiff'))
        ...
        label = imageio.imread(all_labels[index])
        ...
        temp = dirpath_parts[-1].split('\\')
        dirpath_parts = dirpath_parts[:-1]
        dirpath_parts.extend(temp)
    ...
    def __len__(self):
        ...
        return len(glob.glob(os.path.join(self.imgs_folder, '*.tiff')))
...
def test1(data_1, model, device, class_no, save_location):
    ...
    data_1_testoutputs = []
    prediction_map_path = save_location
    output_map_path = save_location
        ...
        for j, (testimg, testlabel, testimgname) in enumerate(data_1):
            ...
            if class_no == 2:
                ...
                if class_no == 8:
                    ...
                    #
                    truth_map[:, :, 0][np.logical_and(testlabel_original[:, :, 0] == 6, testlabel_original[:, :, 1] == 6, testlabel_original[:, :, 2] == 6)] = 102
                    truth_map[:, :, 1][np.logical_and(testlabel_original[:, :, 0] == 6, testlabel_original[:, :, 1] == 6, testlabel_original[:, :, 2] == 6)] = 255
                    truth_map[:, :, 2][np.logical_and(testlabel_original[:, :, 0] == 6, testlabel_original[:, :, 1] == 6, testlabel_original[:, :, 2] == 6)] = 102
                    #
                    ...
                    segmentation_map[:, :, 2][np.logical_and(testoutput_original[:, :, 0] == 6, testoutput_original[:, :, 1] == 6, testoutput_original[:, :, 2] == 6)] = 102
                    #
                    segmentation_map[:, :, 0][np.logical_and(testoutput_original[:, :, 0] == 7, testoutput_original[:, :, 1] == 7, testoutput_original[:, :, 2] == 1)] = 255
                    segmentation_map[:, :, 1][np.logical_and(testoutput_original[:, :, 0] == 7, testoutput_original[:, :, 1] == 7, testoutput_original[:, :, 2] == 1)] = 0
                    segmentation_map[:, :, 2][np.logical_and(testoutput_original[:, :, 0] == 7, testoutput_original[:, :, 1] == 7, testoutput_original[:, :, 2] == 1)] = 0
                    #
                    segmentation_map[:, :, 0][np.logical_and(testoutput_original[:, :, 0] == 8, testoutput_original[:, :, 1] == 8, testoutput_original[:, :, 2] == 2)] = 0
                    segmentation_map[:, :, 1][np.logical_and(testoutput_original[:, :, 0] == 8, testoutput_original[:, :, 1] == 8, testoutput_original[:, :, 2] == 2)] = 255
                    segmentation_map[:, :, 2][np.logical_and(testoutput_original[:, :, 0] == 8, testoutput_original[:, :, 1] == 8, testoutput_original[:, :, 2] == 2)] = 255
                    #
                    segmentation_map[:, :, 0][np.logical_and(testoutput_original[:, :, 0] == 9, testoutput_original[:, :, 1] == 9, testoutput_original[:, :, 2] == 3)] = 93
                    segmentation_map[:, :, 1][np.logical_and(testoutput_original[:, :, 0] == 9, testoutput_original[:, :, 1] == 9, testoutput_original[:, :, 2] == 3)] = 63
                    segmentation_map[:, :, 2][np.logical_and(testoutput_original[:, :, 0] == 9, testoutput_original[:, :, 1] == 9, testoutput_original[:, :, 2] == 3)] = 106
                    #
                    segmentation_map[:, :, 0][np.logical_and(testoutput_original[:, :, 0] == 10, testoutput_original[:, :, 1] == 10, testoutput_original[:, :, 2] == 4)] = 240
                    segmentation_map[:, :, 1][np.logical_and(testoutput_original[:, :, 0] == 10, testoutput_original[:, :, 1] == 10, testoutput_original[:, :, 2] == 4)] = 163
                    segmentation_map[:, :, 2][np.logical_and(testoutput_original[:, :, 0] == 10, testoutput_original[:, :, 1] == 10, testoutput_original[:, :, 2] == 4)] = 255
                    #
                    segmentation_map[:, :, 0][np.logical_and(testoutput_original[:, :, 0] == 11, testoutput_original[:, :, 1] == 11, testoutput_original[:, :, 2] == 5)] = 43
                    segmentation_map[:, :, 1][np.logical_and(testoutput_original[:, :, 0] == 11, testoutput_original[:, :, 1] == 11, testoutput_original[:, :, 2] == 5)] = 206
                    segmentation_map[:, :, 2][np.logical_and(testoutput_original[:, :, 0] == 11, testoutput_original[:, :, 1] == 11, testoutput_original[:, :, 2] == 5)] = 72
                    #
                    truth_map[:, :, 0][np.logical_and(testlabel_original[:, :, 0] == 0, testlabel_original[:, :, 1] == 0, testlabel_original[:, :, 2] == 0)] = 0
                    truth_map[:, :, 1][np.logical_and(testlabel_original[:, :, 0] == 0, testlabel_original[:, :, 1] == 0, testlabel_original[:, :, 2] == 0)] = 0
                    truth_map[:, :, 2][np.logical_and(testlabel_original[:, :, 0] == 0, testlabel_original[:, :, 1] == 0, testlabel_original[:, :, 2] == 0)] = 0
                    ...
                    truth_map[:, :, 0][np.logical_and(testlabel_original[:, :, 0] == 8, testlabel_original[:, :, 1] == 8, testlabel_original[:, :, 2] == 8)] = 0
                    truth_map[:, :, 1][np.logical_and(testlabel_original[:, :, 0] == 8, testlabel_original[:, :, 1] == 8, testlabel_original[:, :, 2] == 8)] = 255
                    truth_map[:, :, 2][np.logical_and(testlabel_original[:, :, 0] == 8, testlabel_original[:, :, 1] == 8, testlabel_original[:, :, 2] == 8)] = 255
                    #
                    truth_map[:, :, 0][np.logical_and(testlabel_original[:, :, 0] == 9, testlabel_original[:, :, 1] == 9, testlabel_original[:, :, 2] == 9)] = 93
                    truth_map[:, :, 1][np.logical_and(testlabel_original[:, :, 0] == 9, testlabel_original[:, :, 1] == 9, testlabel_original[:, :, 2] == 9)] = 63
                    truth_map[:, :, 2][np.logical_and(testlabel_original[:, :, 0] == 9, testlabel_original[:, :, 1] == 9, testlabel_original[:, :, 2] == 9)] = 106
                    #
                    truth_map[:, :, 0][np.logical_and(testlabel_original[:, :, 0] == 10, testlabel_original[:, :, 1] == 10, testlabel_original[:, :, 2] == 10)] = 240
                    truth_map[:, :, 1][np.logical_and(testlabel_original[:, :, 0] == 10, testlabel_original[:, :, 1] == 10, testlabel_original[:, :, 2] == 10)] = 163
                    truth_map[:, :, 2][np.logical_and(testlabel_original[:, :, 0] == 10, testlabel_original[:, :, 1] == 10, testlabel_original[:, :, 2] == 10)] = 255
                    #
                    truth_map[:, :, 0][np.logical_and(testlabel_original[:, :, 0] == 11, testlabel_original[:, :, 1] == 11, testlabel_original[:, :, 2] == 11)] = 43
                    truth_map[:, :, 1][np.logical_and(testlabel_original[:, :, 0] == 11, testlabel_original[:, :, 1] == 11, testlabel_original[:, :, 2] == 11)] = 206
                    truth_map[:, :, 2][np.logical_and(testlabel_original[:, :, 0] == 11, testlabel_original[:, :, 1] == 11, testlabel_original[:, :, 2] == 11)] = 72
                    #

            prediction_name = testimgname + '_pred.png'
            full_error_map_name = os.path.join(prediction_map_path, prediction_name)
            imageio.imsave(full_error_map_name, segmentation_map)
            #
            gt_name = testimgname + '-grdt.png'
