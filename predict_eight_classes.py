...
MODEL_PATH = 'C:/Users/sbng352/Desktop/Healthy_OCT_CNNtraining/Results/SOASNet_Final.pt'
...
def predict(file, output_folder):
    ...
    with torch.no_grad():
        ...
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 0, testoutput_original[:, :, 1] == 0,
        ...
        #
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 1, testoutput_original[:, :, 1] == 1,
        ...
        #
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 2, testoutput_original[:, :, 1] == 2,
        ...
        #
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 3, testoutput_original[:, :, 1] == 3,
        ...
        #
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 4, testoutput_original[:, :, 1] == 4,
        ...
        #
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 5, testoutput_original[:, :, 1] == 5,
        ...
        #
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 6, testoutput_original[:, :, 1] == 6,
        ...
        segmentation_map[:, :, 0][
            np.logical_and(testoutput_original[:, :, 0] == 7, testoutput_original[:, :, 1] == 7,
                           testoutput_original[:, :, 2] == 7)] = 255
        segmentation_map[:, :, 1][
            np.logical_and(testoutput_original[:, :, 0] == 7, testoutput_original[:, :, 1] == 7,
                           testoutput_original[:, :, 2] == 7)] = 0
        segmentation_map[:, :, 2][
            np.logical_and(testoutput_original[:, :, 0] == 7, testoutput_original[:, :, 1] == 7,
                           testoutput_original[:, :, 2] == 7)] = 0
...
if os.path.isfile(input):  # Does input exist?  Is it a file, or a directory?
    ...
    for file in files:
        ...
        predict(inputfile, output_folder)
else:
