...
def trainSingleModel(model_name,
    ...
    # save model
    save_folder = 'C://Users//sbng352//Desktop//OCT_CNNtraining//Results';
    ...
    test_iou_1, test_f1_1, test_recall_1, test_precision_1, mse_1, test_data_1 = test1(data_1=test_data,
                                                                                       model=model,
                                                                                       device=device,
                                                                                       class_no=no_class,
                                                                                       save_location=save_results_folder)
